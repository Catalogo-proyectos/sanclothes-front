...
export function DarkGradientBg({ children, className }: DarkGradientBgProps) {
  return (
    <div className={cn('relative min-h-screen w-full bg-[#17191c] overflow-hidden', className)}>
      <div className="absolute inset-0">
        <div
          className="absolute inset-0 opacity-100"
          style={{
            background: 'radial-gradient(100% 100% at 0% 0%, rgb(46, 46, 46) 0%, rgb(23, 25, 28) 100%)',
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(rgb(80, 82, 74) 0%, rgba(80, 82, 74, 0) 100%)',
